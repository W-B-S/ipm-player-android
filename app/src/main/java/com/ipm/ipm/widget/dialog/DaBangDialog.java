...
public class DaBangDialog extends LinearLayout {

    private Context mContext;
    private LinearLayout ll_root;
    private Dialog dialog;

    public DaBangDialog(Context context) {
        this(context,null);
    }

    public DaBangDialog(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public DaBangDialog(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        LayoutInflater.from(mContext).inflate(R.layout.dialog_dabang,this);
